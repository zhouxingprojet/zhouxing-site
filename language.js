(() => {
  const dictionaries = {
    en: {
      ...
      'Accueil': 'Home', 'Voir le projet': 'View project', 'Faire défiler': 'Scroll', 'Version 2026': 'Version 2026', 'Œuvres sélectionnées': 'Selected works', 'Installation, performance, textile et peinture.': 'Installation, performance, textile and painting.',
    ...
    zh: {
      ...
      'Accueil': '首页', 'Voir le projet': '查看项目', 'Faire défiler': '向下浏览', 'Version 2026': '版本 2026', 'Œuvres sélectionnées': '精选作品', 'Installation, performance, textile et peinture.': '装置、行为、纺织与绘画。',
